...
interface NexacroAPI {
    EventInfo: nexacro.EventInfo;
}

    
declare namespace nexacro {
    type EventInfoOmitKeys = 'id'|'name'|'parent'|'destroy'|'getNumSetter'|'getSetter';
	
	interface EventInfo extends Omit<nexacro.Object, EventInfoOmitKeys> {
	    /**
		 * @constructor
		 */
