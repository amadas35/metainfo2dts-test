...
interface NexacroAPI {
    LoadEventInfo: nexacro.LoadEventInfo;
}

    
declare namespace nexacro {
    
	interface LoadEventInfo extends nexacro.EventInfo {
	    /**
		 * @constructor
		 */
		new(): nexacro.LoadEventInfo;
	    /**
		...
		/**
		 * This property holds the location of a loaded form.
		 */
		readonly url?: string;
	}
}
