...
interface NexacroAPI {
    _EventSinkObject: nexacro.EventSinkObject;
}

    
declare namespace nexacro {
    type EventSinkObjectOmitKeys = 'id'|'getNumSetter'|'getSetter';
	
	interface EventSinkObject extends Omit<nexacro.Object, EventSinkObjectOmitKeys> {
	    /**
		 * @constructor
		 */
		new(): nexacro.EventSinkObject;
	    /**
		 * This property is used to specify the name of a EventSinkObject.
		 */
		readonly name?: string;
		/**
		 * This read-only property holds the parent object of a EventSinkObject.
		 */
		readonly parent?: object;
		/**
		 * @param {string} v This property is used to specify the name of a EventSinkObject.
		 * @returns {void} 
		 */
		set_name(v: string): void;
		/**
		 * This method is used to declare a certain event and then add it to a EventSinkObject.
		 * @param {string} strEventID This is a string that represents the ID of an event to add to the EventSinkObject.
		 * @returns {boolean} 
		 */
		addEvent(strEventID: string): boolean;
		/**
		 * This method is used to add a handler to a certain event of a EventSinkObject.
		...
		/**
		 * This method is used to find a function and add it to a certain event of a EventSinkObject as a handler.
		 * @param {string} strEventID The ID of an event that the handler will be added to
...
If this method fails to find the function in a specified scope, it will then search the regions at higher levels.
		...
		/**
		 * This method is used to delete a EventSinkObject that is dynamically created through a script.
		 * @returns {boolean} 
		 */
		destroy(): boolean;
		/**
		 * This method finds a handler in a certain event of a EventSinkObject and returns the index of the handler.
		...
		/**
		 * This method returns a specific handler from a certain event of a EventSinkObject by specifying the index number of the handler.
...
The index number begins from 0.
		...
		/**
		 * This method is used to add a handler to a certain event of a EventSinkObject at a specified position.
...
If you specify a NaN value, the values will turn to 0 in compliance with ECMA's conversion rule.
		...
		/**
		 * This method is used to remove a certain event that is declared in a EventSinkObject.
		 * @param {string} strEventID This is a string that represents the ID of an event to remove from the EventSinkObject.
		 * @returns {boolean} 
		 */
		removeEvent(strEventID: string): boolean;
		/**
		 * This method is used to remove a handler in a certain event of a EventSinkObject.
		...
		/**
		 * This method is used to find a handler in a certain event of a EventSinkObject and remove it.
		 * @param {string} strEventID The ID of an event that you will search to find the handler
...
If this method fails to find the handler in a specified scope, it will then search the regions at higher levels.
		...
		/**
		 * This method is used to change the first handler in a certain event of a EventSinkObject.
		...
		/**
		 * This method finds a function and uses it to replace the first handler in a certain event of a EventSinkObject.
		 * @param {string} strEventID The ID of the event that holds the existing handler
