...
interface NexacroAPI {
    TrayBalloonTipHideEventInfo: nexacro.TrayBalloonTipHideEventInfo;
}

    
declare namespace nexacro {
    
	interface TrayBalloonTipHideEventInfo extends nexacro.EventInfo {
	    /**
		 * @constructor
		 */
		new(): nexacro.TrayBalloonTipHideEventInfo;
	    /**
